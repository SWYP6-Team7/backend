...
@Entity
@DiscriminatorValue("community_post_like")
public class CommunityPostLikeNotification extends Notification {
    ...
    public CommunityPostLikeNotification(
    ...
    public static CommunityPostLikeNotification create(Community targetPost, Integer notificationCount) {
        return CommunityPostLikeNotification.builder()
                .receiverNumber(targetPost.getUserNumber())
                .title("커뮤니티")
                .content(String.format("[%s]에 좋아요가 %d개 달렸어요.", targetPost.getTitle(), notificationCount))
                .isRead(false)
