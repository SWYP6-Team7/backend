...
public interface CommunityRepository extends JpaRepository<Community, Integer> {
    ...
    @Query("UPDATE Community c SET c.viewCount = c.viewCount + :newViewCount WHERE c.postNumber = :postNumber")
    void combineViewCountByPostNumber(@Param("postNumber") int postNumber, @Param("newViewCount") int newViewCount);
